...
class LibSSH2Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testSshExec() {
        ...
        $this->assertEquals(0, $exit_code, "Exit code: $exit_code\n Std_out: $std_output");
    }
    ...
    public function testSshKeyGen() {
        $this->client->sshKeyGen($std_output, $std_error);
        $this->setExpectedException('Net_SSH2_Exception');
    }
